...
import { getShortDayName, padIconCode } from '../utilities/helpers';
import './default.css';
    ...
    days.forEach((day) => {
      ...
      weatherDays.push(
        <div key={forecast[day].day.daypartName} className="day">
          ...
          <div className="temps">
            <span className="temp-max">{forecast[day].calendarDayTemperatureMax}&deg;</span> |&nbsp;
            <span className="temp-min">{forecast[day].calendarDayTemperatureMin}&deg;</span>
          </div>
